...
Температурные пределы и sentinel-значения задаются единым источником —
`shared/temperature-spec.json` (см. `docs/TEMPERATURE_SPEC.md`). Отдельных
env-переменных для температур нет.
